...
namespace LoginTA {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public TableRow AddTableRow(int Id, string Username, string Email, string Phone_Number, string Password) {
...
namespace LoginTA.Database1DataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table] WHERE (([Id] = @Original_Id) AND ([Username] = @Origina" +
                "l_Username) AND ([Email] = @Original_Email) AND ([Phone_Number] = @Original_Phon" +
                "e_Number) AND ([Password] = @Original_Password))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Id], [Username], [Email], [Phone_Number], [Password])" +
                " VALUES (@Id, @Username, @Email, @Phone_Number, @Password);\r\nSELECT Id, Username" +
                ", Email, Phone_Number, Password FROM [Table] WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [Id] = @Id, [Username] = @Username, [Email] = @Email, [Phone_Number] = @Phone_Number, [Password] = @Password WHERE (([Id] = @Original_Id) AND ([Username] = @Original_Username) AND ([Email] = @Original_Email) AND ([Phone_Number] = @Original_Phone_Number) AND ([Password] = @Original_Password));
SELECT Id, Username, Email, Phone_Number, Password FROM [Table] WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::LoginTA.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Username, Email, Phone_Number, Password FROM dbo.[Table]";
        ...
        public virtual int Delete(int Original_Id, string Original_Username, string Original_Email, string Original_Phone_Number, string Original_Password) {
        ...
        public virtual int Insert(int Id, string Username, string Email, string Phone_Number, string Password) {
        ...
        public virtual int Update(int Id, string Username, string Email, string Phone_Number, string Password, int Original_Id, string Original_Username, string Original_Email, string Original_Phone_Number, string Original_Password) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Username, string Email, string Phone_Number, string Password, int Original_Id, string Original_Username, string Original_Email, string Original_Phone_Number, string Original_Password) {
            return this.Update(Original_Id, Username, Email, Phone_Number, Password, Original_Id, Original_Username, Original_Email, Original_Phone_Number, Original_Password);
        }
    }
